...
class HedgehogPainter extends CustomPainter {
  ...
  void _drawPlayer(Canvas c) {
    ...
    if (sheet != null) {
        ...
        if (s.pState == PlayerState.idle) {
          frameIndex = 0; // Stable, single-frame idle per user request
        } else if (s.pState == PlayerState.jumping || s.pState == PlayerState.falling || s.pState == PlayerState.hurt) {
