...
import 'package:bored_games/features/games/retro_hedgehog/game.dart';
import 'package:bored_games/features/games/tetris/game.dart';
import 'package:bored_games/features/games/minesweeper/game.dart';
...
final router = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      ...
      GoRoute(
        path: '/games/retro_hedgehog',
        pageBuilder: (context, state) => CustomTransitionPage(
          key: state.pageKey,
          transitionDuration: const Duration(milliseconds: 1200),
          reverseTransitionDuration: const Duration(milliseconds: 300),
          child: const RetroHedgehogGame(),
          transitionsBuilder: (context, animation, secondaryAnimation, child) {
            return CyberLaunchTransition(
              animation: animation,
              child: child,
