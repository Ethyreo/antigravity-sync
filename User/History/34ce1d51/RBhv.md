...
- [ ] Sweep for and remove unused variables and imports.
- [ ] Remove development `console.log` debugging statements.
- [ ] Clean up deprecated or heavily commented-out legacy code blocks.
