...
- [ ] Connect `recharts` and create `Dashboard.jsx` for metrics
- [ ] Implement animated MetricCards mapping to Total Rent, Run Rate, Elec, and Water.
- [ ] Build global Filter system (by Floor, Unit, Elec#, Water#) 
- [ ] Create `BuildingVisualMap.jsx` using Grid structures
- [ ] Integrate both into the main `App.jsx` above the existing list
