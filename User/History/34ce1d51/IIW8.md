...
- [ ] Refactor `buildingLayout.js` memory schema to match the live 6-Floor layout exactly
- [ ] Basement: Studio 1, Studio 2
- [ ] Ground: 2RK AirBnB, 2RK Flat
- [ ] First Floor: 2RK Flat, Single Room 1, Single Room 2, 3-Room Unit
- [ ] Second Floor: Silver Oak BnB (Full Floor Unit)
- [ ] Third Floor: Private Residence
- [ ] Fourth Floor: Private Residence (Attic)
- [ ] Reset all Firebase instances to prepare for a fresh Cloud Sync against reality
