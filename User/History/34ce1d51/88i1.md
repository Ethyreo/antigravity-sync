...
- [ ] Refactor `buildingLayout.js` mock data to use `rentHistory` arrays starting Jan 2026
- [ ] Update `UnitDetailModal` to allow adding/editing specific rent cycles (Start Month -> End Month)
- [ ] Implement global expiration alert popup for rent cycles ending soon
