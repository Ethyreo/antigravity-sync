...
- [ ] Get user approval on the Streamlit + PyMuPDF plan.
- [ ] Set up Streamlit environment (`pip install streamlit pymupdf`).
- [ ] Build the PDF to JPEG conversion logic (`fitz`).
- [ ] Build the Streamlit Web App UI (`app.py`).
- [ ] Connect Splitter and Watermarker tools to the UI.
