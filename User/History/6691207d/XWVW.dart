...
import 'package:bored_games/core/widgets/scanline_overlay.dart'; // Added
import 'package:bored_games/app/theme.dart';
import 'logic.dart';
import 'renderer.dart';
import 'parallax_background.dart';
import 'sprite_renderer.dart'; // Added
...
class _RetroHedgehogGameState extends State<RetroHedgehogGame>
  ...
  void initState() {
    ...
    // ParallaxBackground.init(); // Moved to _loadAssets
  ...
  Future<void> _loadAssets() async {
    ...
    await SpriteRenderer.loadAssets();
    if (mounted) {
      setState(() {
        _assetsLoaded = true;
      });
      ...
      children: [
        ...
        Positioned(
          ...
          child: Listener(
            ...
            onPointerUp: (_) => _engine.state.inJump = false,
            onPointerCancel: (_) => _engine.state.inJump = false,
            child: Container(
              width: 64,
              height: 64,
              decoration: BoxDecoration(
