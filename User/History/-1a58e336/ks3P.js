...
export class Input {
    constructor(game) {
        ...
        this.bindings = {
            ...
            up: ['ArrowUp', 'KeyW'],
            down: ['ArrowDown', 'KeyS'],
            jump: ['Space', 'Enter', 'KeyZ', 'KeyJ'], // Removed ArrowUp to avoid menu conflicts
            spin: ['ShiftLeft', 'ShiftRight', 'KeyX', 'KeyK'], // Added X/K as alt spin
            pause: ['Escape', 'KeyP']
        };
    ...
    setupKeyboardEvents() {
        ...
        console.log('🎮 Input system initialized. Press F2 to toggle input debug.');
