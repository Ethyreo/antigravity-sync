...
function App() {
  ...
  const [updateTrigger, setUpdateTrigger] = useState(0); // Forces re-render on data mutate
    ...
    <FilterProvider>
      <div className="min-h-screen pb-24 bg-[#F8FAFC]">
        ...
        <main className="pt-24 px-4 sm:px-6 max-w-5xl mx-auto">
          ...
          {/* New Bulk Update Section Replacing Directory List */}
          <BulkDataEntry key={`bulk-${updateTrigger}`} triggerUpdate={() => setUpdateTrigger(prev => prev + 1)} />
        </main>
