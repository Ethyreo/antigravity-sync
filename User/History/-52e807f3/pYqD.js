    ...
    renderTitle(ctx) {
        ...
        for (let i = 0; i < this.menuItems.length; i++) {
            ...
            if (i === this.selectedIndex) {
                ctx.fillStyle = '#FFD700';
                // Cursor
                const cursorX = NATIVE_WIDTH / 2 - 60;
                ctx.fillText('>', cursorX + Math.sin(this.animationTimer * 0.2) * 3, y);
            } else {
                ctx.fillStyle = '#fff';
            }
        ...
        ctx.fillText('PRESS SPACE TO SELECT', NATIVE_WIDTH / 2, NATIVE_HEIGHT - 20);
    }
