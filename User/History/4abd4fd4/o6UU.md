...
- [ ] Implement Loading Screen <!-- id: 32 --> (New)
    - [ ] Create GlitchText Widget <!-- id: 33 --> (New)
    - [ ] Build Loading Screen with Sequence <!-- id: 34 --> (New)
    - [ ] Update Routing (Swap Home/Splash) <!-- id: 35 --> (New)
...
- [x] Implement First Mini-Game (Placeholder/Simple) <!-- id: 11 -->
    ...
    - [ ] Implement Tic-Tac-Toe AI <!-- id: 36 --> (New)
        - [ ] Create AI Logic (Random, Rules, Minimax) <!-- id: 37 --> (New)
        - [ ] Update State for Game Modes <!-- id: 38 --> (New)
        - [ ] Build Mode Selection UI <!-- id: 39 --> (New)
...
- [x] Implement Second Game: "Neon Snake" <!-- id: 27 --> (New)
    - [x] Create Snake Data Models (Point, Direction) <!-- id: 28 --> (New)
    - [x] Implement Snake Logic (Movement, Growth, Collision) <!-- id: 29 --> (New)
    - [x] Build UI with Cyber Aesthetics (Neon Trail) <!-- id: 30 --> (New)
    - [x] Integrate Haptics & Particles <!-- id: 31 --> (New)
