...
- [ ] Create `MinesweeperState` and `MinesweeperEngine`
- [ ] Implement robust grid generation and random bomb placement (`initBomb`)
- [ ] Implement neighbour bomb counting calculation wrapper
- [ ] Implement flood-fill empty space discovery (`onClick` / `openAll`)
- [ ] Implement flagging system and win/loss detector
