...
- [ ] Update `pubspec.yaml` with image paths
- [ ] Create `SpriteRenderer` utility for loading/drawing sheets
- [ ] Replace Player shapes with Gorgon Sprite Sheets
- [ ] Replace Platform shapes with Swamp Tiles
- [ ] Replace Parallax layers with Background assets
