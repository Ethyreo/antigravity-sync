...
export default function BuildingVisualMap({ onSelectUnit }) {
    ...
    return (
        <div className="bg-white border border-slate-200 rounded-[2rem] p-6 sm:p-10 mb-8 flex flex-col items-center shadow-sm relative overflow-hidden min-h-[500px] justify-end">
            ...
            {/* Generated Apple-style Architecture Background */}
            <div
                className="absolute inset-0 opacity-10 pointer-events-none bg-no-repeat bg-cover bg-center"
                style={{ backgroundImage: "url('/building_facade.png')" }}
            ></div>
                            ...
                            {floor.units.map(unit => {
                                ...
                                return (
                                    <motion.button
                                        ...
                                        className={clsx(
                                            "flex-1 h-12 sm:h-14 rounded-lg border backdrop-blur-sm relative overflow-hidden transition-all duration-500",
                                            unit.isProminent
                                                ? "bg-slate-800/90 border-slate-700 text-white shadow-lg"
                                                : "bg-white/90 border-white/50 text-slate-700 shadow-sm hover:shadow-md",
                                            unit.isPrivate
