...
Use template: C:/Users/Ethyreo/.codex/get-shit-done/templates/research-project/SUMMARY.md
...
```bash
node "C:/Users/Ethyreo/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: complete project research" --files .planning/research/
```
